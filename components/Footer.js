      ...
      <div className="container">
        <div suppressHydrationWarning style={{
          ...
          <div>
            <div suppressHydrationWarning style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
              <div suppressHydrationWarning style={{ position: 'relative', width: '32px', height: '32px' }}>
                <Image src={logo} alt="FixCarKeys Logo" fill style={{ objectFit: 'contain' }} suppressHydrationWarning />
              </div>
          ...
          <div>
            ...
            <div suppressHydrationWarning style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', opacity: 0.9, fontSize: '0.95rem' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', opacity: 0.9, fontSize: '0.95rem' }}>
              <a href={`tel:${phoneNumber.replace(/\s/g, '')}`} suppressHydrationWarning style={{ color: '#D2DCB6', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem' }}>
              <a href={facebookUrl} target="_blank" rel="noopener noreferrer" suppressHydrationWarning style={{
                color: '#F1F3E0',
                fontSize: '1.5rem',
              ...
              <a href={instagramUrl} target="_blank" rel="noopener noreferrer" suppressHydrationWarning style={{
                color: '#F1F3E0',
                fontSize: '1.5rem',
                transition: 'opacity 0.3s ease'
              }}>
              ...
              <a href={tiktokUrl} target="_blank" rel="noopener noreferrer" suppressHydrationWarning style={{
                color: '#F1F3E0',
                fontSize: '1.5rem',
                transition: 'opacity 0.3s ease'
              }}>
              ...
              <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noopener noreferrer" suppressHydrationWarning style={{
                color: '#F1F3E0',
                fontSize: '1.5rem',
                transition: 'opacity 0.3s ease'
              }}>
        ...
        <div suppressHydrationWarning style={{
          ...
          <p suppressHydrationWarning>© 2024 FixCarKeys. All rights reserved.</p>
