        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '1rem' }}>
              <a href="https://www.facebook.com/profile.php?id=61557261796916" target="_blank" rel="noopener noreferrer" style={{
                color: '#F1F3E0',
                fontSize: '1.5rem',
              ...
              <a href="https://www.instagram.com/fixcarkeys" target="_blank" rel="noopener noreferrer" style={{
                color: '#F1F3E0',
                fontSize: '1.5rem',
                transition: 'opacity 0.3s ease'
              }}>
              ...
              <a href="https://tiktok.com/@FixCarKeys" target="_blank" rel="noopener noreferrer" style={{
                color: '#F1F3E0',
                fontSize: '1.5rem',
                transition: 'opacity 0.3s ease'
              }}>
