...
export async function seedDefaultData() {
  ...
  const defaultSettings = [
    ...
    { key: 'email', value: 'fixcarkeys@yahoo.com' },
  ...
  // Default areas
  const defaultAreas = [
    { name: 'Wigan', towns: JSON.stringify(['Locksmith in Hindley', 'Locksmith in Abram', 'Locksmith in Ashton-in-Makerfield', 'Locksmith in Ince-in-Makerfield', 'Locksmith in Golborne', 'Locksmith in Orrell', 'Locksmith in Standish', 'Locksmith in Atherton', 'Locksmith in Tyldesley', 'Locksmith in Shevington', 'Locksmith in Billinge', 'Locksmith in Appley Bridge', 'Locksmith in Haigh']) },
    { name: 'Warrington', towns: JSON.stringify(['Locksmith in Widnes', 'Locksmith in Runcorn', 'Locksmith in Frodsham', 'Locksmith in Newton-le-Willows', 'Locksmith in Leigh', 'Locksmith in Croft', 'Locksmith in St Helens', 'Locksmith in Lymm', 'Locksmith in Appleton', 'Locksmith in Stockton Heath', 'Locksmith in Penketh', 'Locksmith in Great Sankey', 'Locksmith in Birchwood']) },
    { name: 'Bolton', towns: JSON.stringify(['Locksmith in Westhoughton', 'Locksmith in Horwich', 'Locksmith in Farnworth', 'Locksmith in Little Lever', 'Locksmith in Blackrod', 'Locksmith in Kearsley', 'Locksmith in Belmont', 'Locksmith in Lostock', 'Locksmith in Egerton', 'Locksmith in Edgworth', 'Locksmith in Bradshaw', 'Locksmith in Bromley Cross', 'Locksmith in Harwood', 'Locksmith in Smithills', 'Darcy Lever']) },
    { name: 'Liverpool', towns: JSON.stringify(['Locksmith in Birkenhead', 'Locksmith in Wallasey', 'Locksmith in Litherland', 'Locksmith in Bootle', 'Locksmith in Bebington', 'Locksmith in Crosby', 'Locksmith in Kirkby', 'Locksmith in Heswall', 'Locksmith in Prescot', 'Locksmith in Formby', 'Locksmith in Huyton']) },
    { name: 'Manchester', towns: JSON.stringify(['Locksmith in Altrincham', 'Locksmith in Blackley', 'Locksmith in Bury', 'Locksmith in Cheshire', 'Locksmith in Chorlton-cum-Hardy', 'Locksmith in Didsbury', 'Locksmith in Levenshulme', 'Locksmith in Oldham', 'Locksmith in Rochdale', 'Locksmith in Stockport', 'Locksmith in Salford', 'Locksmith in Stretford', 'Locksmith in Trafford', 'Locksmith in Tameside', 'Locksmith in Withington']) },
    { name: 'Stoke-on-Trent', towns: JSON.stringify(['Locksmith in Newcastle-under-Lyme', 'Locksmith in Kidsgrove', 'Locksmith in Biddulph', 'Locksmith in Alsager', 'Locksmith in Audley', 'Locksmith in Stone', 'Locksmith in Burslem', 'Locksmith in Tunstall', 'Locksmith in Hanley', 'Locksmith in Longton', 'Locksmith in Fenton', 'Locksmith in Knutsford', 'Locksmith in Winsford', 'Locksmith in Macclesfield', 'Locksmith in Northwich']) },
    { name: 'Chester & Ellesmere Port', towns: JSON.stringify(['Locksmith in Frodsham', 'Locksmith in Helsby', 'Locksmith in Tarporley', 'Locksmith in Tattenhall', 'Locksmith in Kelsall', 'Locksmith in Tarvin', 'Mickle Trafford', 'Locksmith in Elton', 'Locksmith in Little Budworth', 'Locksmith in Christleton', 'Locksmith in Huntington', 'Locksmith in Great Barrow', 'Locksmith in Backford', 'Locksmith in Capenhurst']) },
    { name: 'Southport & Chorley', towns: JSON.stringify(['Locksmith in Ainsdale', 'Locksmith in Birkdale', 'Locksmith in Formby', 'Locksmith in Hightown', 'Locksmith in Banks', 'Locksmith in Crossens', 'Locksmith in Marshside', 'Locksmith in Tarleton', 'Locksmith in Adlington', 'Locksmith in Clayton-le-Woods', 'Locksmith in Euxton', 'Locksmith in Coppull', 'Locksmith in Whittle-le-Woods', 'Locksmith in Brinscall', 'Locksmith in Heath Charnock', 'Locksmith in Eccleston']) },
    { name: 'Skelmersdale & Ormskirk', towns: JSON.stringify(['Locksmith in Up Holland', 'Locksmith in Parbold', 'Locksmith in Appley Bridge', 'Locksmith in Dalton', 'Locksmith in Newburgh', 'Locksmith in Wrightington', 'Locksmith in Westhead', 'Locksmith in Lathom', 'Locksmith in Burscough', 'Locksmith in Aughton', 'Locksmith in Maghull', 'Locksmith in Mawdesley', 'Locksmith in Halsall', 'Locksmith in Rufford', 'Locksmith in Scarisbrick']) },
  ];
